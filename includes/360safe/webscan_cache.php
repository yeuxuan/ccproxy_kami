...
$webscan_white_url = array('shopedit.php' => 'my=edit_submit', '/shopedit.php' => 'my=add_submit', 'message.php' => 'my=add_submit', '/message.php' => 'my=edit_submit', 'article.php' => 'my=add_submit', '/article.php' => 'my=edit_submit', '/uset.php' => 'mod=site_n', '/ajax.php' => 'act=set', '/ajax_shop.php' => 'act=batchaddgoods');
?>