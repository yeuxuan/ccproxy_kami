                                                                ...
                                                                <table class="table table-striped mb-0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            echo (version_compare(PHP_VERSION, '7.3', '>')) ? '<font color="green">' . PHP_VERSION . '</font>' : '<font color="red">' . PHP_VERSION . '</font>'; ?>
                                                                        </td>
                                                                        <td>
                                                                            PHP版本支持
                                                                        </td>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <form class="layui-form form-horizontal">
                                                            ...
                                                            <div class="form-group row mb-3">
                                                                <label class="col-md-3 col-form-label font-weight-light"
                                                                       for="switch"><a href="disclaimer.html"
                                                                                       target="_blank"
