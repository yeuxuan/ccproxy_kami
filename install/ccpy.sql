...
(1, 'admin', '123456', '一花端口', 'dcd4OiHX5V1sDKHev8VMTHE6H8bK0X4hoXhmVrSVTT9l25bD56DLoQg8OpKUnP5Nr0Uxdbx5AEeu9nbMJGj+KGxk7w', '2022-01-12 11:24:34', '2023-03-12 16:00:00', 'localhost:7788', 1, 'https://www.keaidian.com/uploads/allimg/190424/24110307_5.jpg', '注意<br>PHP版本最好设置为7.3<br>不然容易出现问题<br><div style=\"color:red\"><span>我是公告</span></div>我是公告', 'http://wpa.qq.com/msgrd?v=3&uin=487735913&site=qq&menu=yes', 'https://www.keaidian.com/uploads/allimg/190424/24110307_5.jpg', 1, 0);
...
--
ALTER TABLE `application`
  MODIFY `appid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56516;
...
--
ALTER TABLE `log`
  MODIFY `logid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
